...
from config.ratelimit import RateLimitMixin, UserRateLimitMixin
...
class EventUpdateView(
    UserRateLimitMixin, LoginRequiredMixin, EventOwnerMixin, UpdateView
):
...
class EventDuplicateView(UserRateLimitMixin, LoginRequiredMixin, View):
